...
public:
    ...
    enum BitMaskSip
    {
        SIP_SSIP = (1 << 1), //software inter enable
        SIP_STIP = (1 << 5),//trap enable
        SIP_SEIP = (1 << 9),//extern enable
    };
    ...
    /*
    PREKIDNA RUTINA,PROCESOR POZIVA KADA SE POJAVI NEKI ZAHTEV ZA PREKIDOM ILI EXCEPTION
    POZIVACE SE TEK KADA MI TO ZELIMO
    */
